...
//            utn_getTexto("getTexto\n: ","\nError",1,TEXT_SIZE,1,array[posicion].varLongString);                 //mensaje + cambiar campo varLongString
            printf("\n Posicion: %d\n ID: %d\n idAutor: %d\n titulo: %s",
                   posicion, array[posicion].idLibro,array[posicion].idAutor,array[posicion].titulo);
            retorno=0;
        }
    }
    return retorno;
...
//    char bufferLongString[TEXT_SIZE];                           //cambiar campo varLongString
    ...
    if(array!=NULL && size>=0)
    {
        for (i = 1; i < size; i++)
        {
            ...
            bufferInt=array[i].idAutor;                                //cambiar campo idAutor
...
//            strcpy(bufferLongString,array[i].varLongString);          //cambiar campo varLongString
            ...
            j = i - 1;
            while ((j >= 0) && strcmp(bufferString,array[j].titulo)<0)         //cambiar campo titulo                 //Si tiene mas de un criterio se lo agrego, Ej. bufferInt<array[j].idAutor
            {                                                                                                               //buffer < campo ascendente   buffer > campo descendente
                ...
                array[j + 1].idAutor=array[j].idAutor;                        //cambiar campo idAutor
...
//                strcpy(array[j + 1].varLongString,array[j].varLongString);  //cambiar campo varLongString
            ...
            array[j + 1].idAutor=bufferInt;                                                        //cambiar campo idAutor
    ...
    if(array!=NULL && size>=0)
    {
        for(i=0;i<size;i++)
        {
            if(array[i].isEmpty==1)
                ...
                printf("\n ID: %d\n idAutor: %d\n titulo: %s",
                       array[i].idLibro,array[i].idAutor,array[i].titulo);      //cambiar todos
        }
        retorno=0;
    }
    return retorno;
